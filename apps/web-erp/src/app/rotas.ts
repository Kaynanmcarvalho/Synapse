...
export const ROTAS = {
  ...
  gruposDeFornecedor: '/cadastros/fornecedores/grupos',
  subgruposDeFornecedor: '/cadastros/fornecedores/sub-grupos',
  funcionarios: '/cadastros/funcionarios',
  cargosDeFuncionario: '/cadastros/funcionarios/cargos',
  departamentos: '/cadastros/funcionarios/departamentos',
  pracasERegioes: '/cadastros/pracas-e-regioes',
