...
import { formatarDocumento, formatarMoeda } from '../../customers/formato';
...
/** Pedido, Cliente (F10), Endereço, Vendedor e Mesa/Cartão, com a situação do
 *  caixa: quando abriu e quanto de dinheiro deve ter na gaveta. */
