...
export function Cartao({
  ...
  return (
    <section className="border-hairline-light bg-canvas-light shadow-cartao hover:shadow-cartao-alto flex h-full min-h-0 min-w-0 flex-col rounded-2xl border transition-shadow duration-300">
